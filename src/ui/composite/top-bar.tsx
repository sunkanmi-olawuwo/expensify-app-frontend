        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-3 lg:hidden">
            <Sheet open={mobileNavOpen} onOpenChange={setMobileNavOpen}>
              ...
              <SheetContent
                className="bg-surface-container-low w-[22rem] border-none p-3"
          ...
          <div className="min-w-[12rem] flex-1">
            ...
            <p className="text-title-lg text-foreground mt-1">
              {pageChrome.title}
            </p>
          </div>

          <div className="relative min-w-[16rem] flex-1 lg:max-w-md">
            <Input
